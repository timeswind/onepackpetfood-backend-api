...
exports.orderPaid = function (order_id, payment_method) {
  return Order.findOneAndUpdate({ _id: order_id }, { $set: { payment_type: payment_method, status: "WAIT_SELLER_SEND_GOODS" } }).exec();
}