...
exports.getByWxOpenId = function(wx_openid) {
  return User.findOne({"wx_openid": wx_openid}).exec();
}
...
exports.patchUserWxOpenIds = function(user_id, type, openid) {
  ...
  var update = {}
  update[type] = openid
  return User.findOneAndUpdate({"_id": user_id}, {$set: {wx_openids: update}}).exec();
}
